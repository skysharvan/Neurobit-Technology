  ...
  return (
    <>
      <Box sx={{width:'100%', height:'570px',display:'flex',flexDirection:'column',alignItems:'center',margin:'30px 0px'}}>
           ...
           {/* <Box sx={{width:'90%',height:'102px',boxShadow:'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px',margin:'20px 0px',display:'flex',alignItems:'center',gap:'70px'}}>
                <Box sx={{display:'flex',}}>
                   <Typography sx={{fontSize:'20px',margin:'0px 20px'}}>EOGL-A2</Typography>
                </Box>
                <Autocomplete
                    disablePortal
                    id="combo-box-demo"
           ...
           <Box sx={{width:'90%',height:'102px',boxShadow:'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px',margin:'20px 0px',display:'flex',alignItems:'center',gap:'60px'}}>
                <Box sx={{display:'flex',}}>
                   <Typography sx={{fontSize:'20px',margin:'0px 20px'}}>EOGR-A1</Typography>
                </Box>
                <Autocomplete
